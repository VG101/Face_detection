...
class RecogEigenFaces:
    def __init__(self):
        cascPath="haarcascade_frontalface_default.xml" #classifier used to detect frontalface, this is provided in cv2 data
    ...
    def process_image(self, inImg):
        ...
        for i in range(len(faces)):
            ...
            if confidence[1] < 3500:
                ...
                cv2.rectangle(frame, (x,y), (x+w, y+h), (255,0,0), 3) #draw rectangle on faces
                cv2.putText(frame,'%s - %.0f' % (person, confidence[1]), (x-10, y-10), cv2.FONT_HERSHEY_PLAIN,1,(0,255,0)) #confidence value
            else:
                person = 'Unknown'
